...
void App_AgarioGame_BT::Start()
{
	...
	for (int i = 0; i < m_AmountOfAgents; i++)
	{
		...
		Elite::BehaviorTree* pBehaviorTree = new BehaviorTree(pBlackBoard, new BehaviorAction(ChangeToWander));
	...
	Elite::BehaviorTree* pBehaviorTree = new BehaviorTree(pBlackBoard, new BehaviorSelector(
		{
			new BehaviorSequence(
			{
				new BehaviorConditional(IsFoodNearby),
